...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/gitbud', name: 'gitbud', component: () => import('./pages/GitBudPage.vue'), meta: { title: 'GitKittie Bud — Rewriting git history, made visual' } },
    { path: '/docs', name: 'docs', component: () => import('./pages/DocsPage.vue'), meta: { title: 'Docs — GitKittie Folder' } },
