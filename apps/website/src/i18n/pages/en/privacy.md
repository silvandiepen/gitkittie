This policy covers the GitKittie apps — **GitFolder**, **GitKanban** and **GitBud**. All are local-first macOS utilities. They are designed so that your data never passes through GitKittie servers, because there are none.
